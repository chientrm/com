...
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `android.permission.INTERNET`               | Retrieving, uploading, and playing audio streams online                                                                |
| `android.permission.READ_EXTERNAL_STORAGE`  | Uploading audio from user's devices to the cloud. Download audio from the cloud to local storage for offline playback. |
| `android.permission.FOREGROUND_SERVICE`     | Playing audio in the background without required user intervention.                                                    |
| `android.permission.ACCESS_COARSE_LOCATION` | Suggestion of audios shared by nearby users.                                                                           |
